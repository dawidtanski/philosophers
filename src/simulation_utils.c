...
/*   Updated: 2025/04/14 12:32:32 by dtanski          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sleeping(t_philo	*philo)
{
	...
	t = get_long(&philo->table->table_mtx, &philo->table->time_to_sleep);
	print_output(SLEEPING, philo);
	precise_usleep(t * 1000, philo->table);
}
...
void	eat(t_philo *philo)
{
	...
	precise_usleep(t_to_eat * 1000, philo->table);
